...
Nbody=10000
mcp_xv = np.load('/suphys/aani0116/Work/minicluster_tidal/hpc/tidal_timestep/mcp_xv.npy')
mcp_mass=np.load('/suphys/aani0116/Work/minicluster_tidal/hpc/tidal_timestep/mcp_mass.npy')
...
n_snapshots = 10
snapshot_interval = max(1, int(simulation_time / 1e-3 / n_snapshots))
step = 0
mcp_xv_snapshots=[]
...
fname = f'/suphys/aani0116/Work/minicluster_tidal/hpc/tidal_timestep/mc_adaptive_step{mc.mass:.1e}_c{mc.concentration}_d{mc.delta}.h5'
